...
impl<'a, 'b> Painter<'a, 'b> {
    ...
    /// # Examples:
    /// ```
    /// use zui_widgets::{symbols, widgets::canvas::{Painter, Context}};
    ///
    ...
    /// # Examples:
    /// ```
    /// use zui_widgets::{style::Color, symbols, widgets::canvas::{Painter, Context}};
    ///
...
///
/// ```
/// # use zui_widgets::widgets::{Block, Borders};
/// # use zui_widgets::layout::Rect;
/// # use zui_widgets::widgets::canvas::{Canvas, Shape, Line, Rectangle, Map, MapResolution};
/// # use zui_widgets::style::Color;
/// Canvas::default()
    ...
    F: Fn(&mut Context),
{
    ...
    ///
    /// ```
    /// # use zui_widgets::widgets::canvas::Canvas;
